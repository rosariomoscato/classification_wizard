...
def nb_main():
  ...
  if status == True:
    ...
    with st.expander('Advanced Parameters'):
      ...
      st.markdown(
        'For further information please refer to ths [link](https://scikit-learn.org/stable/modules/generated/sklearn.naive_bayes.GaussianNB.html)'
      )
    ...
    try:
      ...
      st.markdown(download(
        ...
        'Classification Wizard - Naive Bayes Classifier - Hyperparameters'),
      ...
      if status_test == True:
        try:
          ...
          st.markdown(download(
            X_pred,
            'Classification Wizard - Naive Bayes Classifier - Predicted Labels'
          ),
                      unsafe_allow_html=True)
      ...
      st.warning(
        'Please select at least one feature, a suitable label and appropriate advanced parameters'
      )
